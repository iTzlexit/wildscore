...
| [docs/MAPS.md](docs/MAPS.md) | Whether to build a map, what the competition ships, and the rhino rule that constrains it |
| **[docs/RISKS.md](docs/RISKS.md)** | **What could actually kill this**, ordered by damage. Read before planning a launch |
